...
- **[ICML 2026 Accepted]** Haowen Xu, Xue Tan, **Lei Ma**, Zhihao Zhang, Chao Wang, Qingze Wang, Ping Chen, Jun Dai, Xiaoyan Sun.*When Agents Go Rogue: Activation-Based Detection of Malicious Behaviors in Multi-Agent Systems.* [Paper](https://openreview.net/forum?id=BnduUW8izq)
...
- **[SIGMOD 2025]** **Lei Ma**, Lei Cao, Peter M. VanNostrand, Dennis M. Hofmann, Yao Su, Elke A. Rundensteiner. *Pluto: Sample Selection for Robust Anomaly Detection on Polluted Log Data*. [Paper](https://dl.acm.org/doi/10.1145/3677139)
- **[VLDB 2024]** Peter M. VanNostrand, Dennis M. Hofmann, **Lei Ma**, Belisha Genin, Randy Huang, Elke A.Rundensteiner. *Counterfactual Explanation Analytics: Empowering Lay Users to Take Action Against Consequential Automated Decision*s. [Paper](https://www.vldb.org/pvldb/vol17/p4349-vannostrand.pdf)
- **[FaccT 2024]** Peter M. VanNostrand, Dennis M. Hofmann, **Lei Ma**, Elke A. Rundensteiner. *Actionable Recourse for Automated Decisions: Examining the Effects of Counterfactual Explanation Type and Presentation on Lay User Understanding*. [Paper](https://dl.acm.org/doi/abs/10.1145/3630106.3658997?casa_token=BTqK64dg3ywAAAAA:kQJK7M9vYXDdhvNZWxJODsS_R6K_gSup0cjSivqH8XSfJKdo165cJortF5LBKBMggCwBjF0HiLunrA)
- **[KDD 2023]** Yao Su, Zhentian Qian, **Lei Ma**, Lifang He, Xiangnan Kong. *One-shot Joint Extraction, Registration and Segmentation of Neuroimaging Data*. [Paper](https://arxiv.org/abs/2307.15198)
- **[SIGMOD 2022]** **Lei Ma**, Chuan Lei, Olga Poppe, Elke A. Rundensteiner. *Gloria: Graph-based Sharing Optimizer for Event Trend Aggregation*. [Paper](https://dl.acm.org/doi/10.1145/3514221.3526145)
...
- CS 2303 Systems Programming Concepts, Term C 2019
- CS 2301 Systems Programming for Non-Majors, Term D 2019
- CS 3516 Computer Networks, Term A 2019
